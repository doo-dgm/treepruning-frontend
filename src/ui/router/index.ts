...

  {
    ...
    children: [
      ...
      },
      {
        ...
        meta:      { title: 'Administracion', roles: ['MANAGER', 'ADMIN'] },
      },
      {
        path:      'podas',
        name:      'podas',
        component: PruningManagement,
        meta:      { title: 'Manejo de podas', roles: ['MANAGER', 'ADMIN'] },
      },
      {
        path:      'pqr',
        name:      'pqr',
        component: PQR,
        meta:      { title: 'PQR', roles: ['PERSON', 'MANAGER', 'ADMIN'] },
      },
      {
        path:      'estadisticas',
        name:      'estadisticas',
        component: Statistics,
        meta:      { title: 'Estadísticas', roles: ['MANAGER', 'ADMIN'] },
      },
    ],
  },
